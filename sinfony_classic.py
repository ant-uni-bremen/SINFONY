...
def simulation_sinfony_classic(settings_path, test_mode=False, snrs=None):
    '''SINFONY classic simulation
    '''
    ...
    pathfile_results = os.path.join(path_script, path_classic, simulation_filename_prefix +
                                    filename + simulation_filename_suffix)
...
if __name__ == '__main__':
    ...
    path_script = os.path.dirname(os.path.abspath(__file__))
    # Default: 'classic/config_classic'
    SETTINGS_FILE = 'classic/config_classic'
