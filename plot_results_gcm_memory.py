...
if __name__ == '__main__':
    ...
    gcm_memory_mnist_ntx56 = {'title': ['SINFONY: GCM MNIST ntx56 Memory', 'mnist', 56, False],
                              ...
                              'GCM snr prob Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'r:', 56, True],
                              'GCM snr opt Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf + '_opt', 'r:x', 56, True],
                              'GCM snr Nfeat 5 Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr_Nfeatures5+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'm:', 56, True],
                              'GCM snr Nfeat 10 Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr_Nfeatures10+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'g:', 56, True],
                              'GCM snr Nfeat 20 Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr_Nfeatures20+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'y:', 56, True],
                              'GCM snr Nfeat 40 Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr_Nfeatures40+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'b:', 56, True],
                              'GCM snr Nfeat max Ne1 + SINFONY ntx56 Ne20 snr-4 6 human': [dn + 'GCM_snr_Nfeatures-1+sinfony14_MNIST_ntx56_Ne20_snr-4_6_human' + suf, 'c:', 56, True],
                              }
