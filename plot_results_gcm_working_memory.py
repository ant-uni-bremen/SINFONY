...
if __name__ == '__main__':
    ...
    gcm_working_memory_mnist = {'title': ['SINFONY: GCM MNIST ntx14 Memory', 'mnist', 56, False],
                                ...
                                'GCM snr-4 6 prob Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'b-x', 14, True],
                                # 'GCM snr-4 6 opt Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'b-x', 14, True],
                                ...
                                # 'GCM snr-4 6 Nfeat 5 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures5+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'm:', 14, True],
                                # 'GCM snr-4 6 opt Nfeat 5 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures5+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'm:*', 14, True],
                                # 'GCM snr-4 6 Nfeat 10 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures10+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'g:', 14, True],
                                # 'GCM snr-4 6 opt Nfeat 10 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures10+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'g:*', 14, True],
                                # 'GCM snr-4 6 Nfeat 20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures20+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'y:', 14, True],
                                # 'GCM snr-4 6 opt Nfeat 20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures20+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'y:*', 14, True],
                                # 'GCM snr-4 6 Nfeat 40 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures40+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'b:', 14, True],
                                # 'GCM snr-4 6 opt Nfeat 40 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures40+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'b:*', 14, True],
                                # 'GCM snr-4 6 Nfeat max Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures-1+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'c:', 14, True],
                                # 'GCM snr-4 6 opt Nfeat max Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_snr-4_6_Nfeatures-1+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'c:*', 14, True],
                                }
