...
if __name__ == '__main__':
    ...
    speechcmd = {'title': ['SINFONY+GCM: speech commands', 'speechcommands', 512, False],
                 ...
                 # 'resnet18 imagenet 2': [dn + 'ResNet18_speechcommands_imagenet_2' + suf, 'k--d', 0, True],
                 ...
                 # 'GCM opt + SINFONY ntx64': [dn + 'GCM+sinfony_speechcommands_imagenet_ntx64' + '_opt' + suf, 'r--x', 64, True],
    ...
    speechcmd_classic = {'title': ['SINFONY: speech commands classic', '', 512, False],
                         ...
                         'sinfony ntx512 imagenet': ['speechcommands/' + dn + 'sinfony_speechcommands_imagenet' + suf, 'r-s', 512, True],
                         'sinfony ntx64 imagenet': ['speechcommands/' + dn + 'sinfony_speechcommands_imagenet_ntx64' + suf, 'g-d', 64, True],
    ...
    urbansound8k = {'title': ['SINFONY+GCM: urbansound8k', 'urbansound8k', 512, False],
                    ...
                    # 'resnet18 imagenet full': [dn + 'ResNet18_urbansound8kfull_imagenet' + suf, 'k--d', 0, True],
                    ...
                    # 'GCM test opt + SINFONY ntx64 snr-4 6': [dn + 'GCMtest+sinfony_urbansound8k_imagenet_ntx64' + '_opt' + suf, 'r-.x', 64, True],
                    # 'GCM opt + SINFONY ntx64': [dn + 'GCM+sinfony_urbansound8k_imagenet_ntx64' + '_opt' + suf, 'r--x', 64, True],
    ...
    urbansound8k_classic = {'title': ['SINFONY: urbansound8k classic', '', 512, False],
                            ...
                            'sinfony ntx512 imagenet': ['urbansound8k/' + dn + 'sinfony_urbansound8k_imagenet' + suf, 'r-s', 512, True],
                            'sinfony ntx64 imagenet': ['urbansound8k/' + dn + 'sinfony_urbansound8k_imagenet_ntx64' + suf, 'g-d', 64, True],
