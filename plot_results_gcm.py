...
if __name__ == '__main__':
    ...
    # SINFONY for integration with human decision-making journal with sociologists, e.g., with tool dataset
    ...
    tools = {'title': ['SINFONY: Tool Wear (705, 380, 1)', '', 256 + 256, False],
             ...
             'ResNet18 2': ['fraeser/' + dn + 'ResNet18_fraeser' + suf, 'k--', 0, True],
             ...
             # 'SINFONY snr-4 6 ntx512': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3' + suf, 'r-o', 512, True],
             # 'SINFONY snr-4 6 ntx512 txrx weight_decay': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_test' + suf, 'r--x', 512, True],
             # 'SINFONY snr-4 6 ntx512 2': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_2' + suf, 'r--s', 512, True],
             'SINFONY snr-4 6 ntx512 3': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_3' + suf, 'r-s', 512, True],
             # 'SINFONY snr-4 6 ntx512 4': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_4' + suf, 'r--o', 512, True],
             # 'SINFONY snr-4 6 ntx512 5': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_5' + suf, 'r--D', 512, True],
             # 'SINFONY snr-4 6 ntx512 6': ['fraeser/' + dn + 'sinfony18_fraeser_lr1e-3_6' + suf, 'r--<', 512, True],
             # 'SINFONY snr-4 6 full image': ['fraeser/' + dn + 'sinfony18_fraeser_fullimage' + suf, 'k--s', 512, True],
             'SINFONY snr-4 6 ntx128': ['fraeser/' + dn + 'sinfony18_fraeser_ntx128' + suf, 'g-d', 128, True],
             # 'SINFONY snr-4 6 ntx256': ['fraeser/' + dn + 'sinfony18_fraeser_ntx256' + suf, 'g--x', 256, True],
             # 'SINFONY snr-4 6 ntx64': ['fraeser/' + dn + 'sinfony18_fraeser_ntx64' + suf, 'g--o', 64, True],
             # 'SINFONY snr-4 6 ntx16': ['fraeser/' + dn + 'sinfony18_fraeser_ntx16' + suf, 'g--s', 16, True],
             # 'SINFONY snr-4 6 ntx32': ['fraeser/' + dn + 'sinfony18_fraeser_ntx32' + suf, 'g--<', 32, True],
             ...
             # 'ResNet18 image classic rc25 n=15360 h1 2': ['classic/' + dn + 'classic_image_' + 'ResNet18_fraeser_rc25_n15360_h1_test' + suf, 'k--x', (218 + 487) * 380 / 2 * 1 * 8 / (0.25 * HUFF_GAIN_FRAESER_IMAGES), True],
    ...
    tools64 = {'title': ['SINFONY: Tool Wear (118, 64, 1)', 'fraeser', 36 + 64, False],
               ...
               # 'SINFONY 64x64 ntx100 txrx weight_decay': [dn + 'sinfony6_fraeser64_test' + suf, 'r--o', 100, True],
               'SINFONY 64x64 ntx100': [dn + 'sinfony6_fraeser64' + suf, 'r-d', 100, True],
               # 'SINFONY 64x64 ntx100 2': [dn + 'sinfony6_fraeser64_2' + suf, 'r-o', 100, True],
               # 'SINFONY 64x64 ntx100 ResNet14 ': [dn + 'sinfony14_fraeser64' + suf, 'r-x', 100, True],
               # 'SINFONY 64x64 ntx100 snr6 16': [dn + 'sinfony6_fraeser64_snr6_16' + suf, 'r-s', 100, True],
               ...
               'SINFONY 64x64 ntx16': [dn + 'sinfony6_fraeser64_ntx16' + suf, 'g-d', 16, True],
               # 'SINFONY 64x64 ntx16 snr6 16': [dn + 'sinfony6_fraeser64_ntx16_snr6_16' + suf, 'g-s', 16, True],
               }
    # selected_plots.append(tools64)

    sinfony_human_mnist = {'title': ['SINFONY for human MNIST', 'mnist', 56, False],
                           # 'Tag': ['data name', 'color in plot', channel uses, on/off],
    ...
    # selected_plots.append(sinfony_human_mnist)
    ...
    gcm_mnist_ntx14 = {'title': ['SINFONY+GCM: MNIST ntx14', 'mnist', 56, False],
                       ...
                       'GCM prob Ne10 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Ne10+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'r:', 14, True],
    ...
    gcm_opt_mnist_ntx14 = {'title': ['SINFONY+GCM: MNIST ntx14 optimal policy', 'mnist', 56, False],
                           ...
                           'GCM opt Ne10 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Ne10+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'r:', 14, True],
                           'GCM opt Nfeat 5 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Nfeatures5+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'm-', 14, True],
                           'GCM opt Nfeat 10 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Nfeatures10+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'g-', 14, True],
                           'GCM opt Nfeat 20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Nfeatures20+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'y-', 14, True],
                           'GCM opt Nfeat 40 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Nfeatures40+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'b-', 14, True],
                           'GCM opt Nfeat max Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Nfeatures-1+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'c-', 14, True],
                           }
    # selected_plots.append(gcm_opt_mnist_ntx14)

    sinfony_human_cifar = {'title': ['SINFONY for human CIFAR10', 'cifar10', 64, False],
                           # 'Tag': ['data name', 'color in plot', channel uses, on/off],
    ...
    # selected_plots.append(sinfony_human_cifar)
    ...
    gcm_cifar_ntx16 = {'title': ['SINFONY+GCM: CIFAR10 ntx16', 'cifar10', 64, False],
                       ...
                       'SINFONY ntx64 nrx64 snr-4 6': [dn + 'sinfony20_CIFAR_ntx64_snr-4_6_human' + suf, 'k--x', 64, True],
    ...
    gcm_mnist_ntx14_joint_training = {'title': ['SINFONY+GCM: MNIST ntx14 joint training', 'mnist', 56, False],
                                      ...
                                      'GCM prob Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf, 'r-', 14, True],
                                      # 'GCM opt Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human' + suf + '_opt', 'r--x', 14, True],
                                      'GCM prob Ne1 joint training Nalt20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human+joint_training' + suf, 'r-.', 14, True],
                                      # 'GCM opt Ne1 joint training Nalt20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human+joint_training' + suf + '_opt', 'r--*', 14, True],
                                      ...
                                      'GCM prob Ne1 joint training Nalt20 Ne3 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Ne3+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human+joint_training' + suf, 'r:', 14, True],
                                      ...
                                      'GCM diff prob Ne1 joint training Nalt20 Ne1 + SINFONY ntx14 Ne20 snr-4 6 human': [dn + 'GCM_Ne1_Na20_differentiable+sinfony14_MNIST_ntx14_Ne20_snr-4_6_human+joint_training' + suf, 'r-.*', 14, True],
                                      }
